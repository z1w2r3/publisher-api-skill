...
脚本路径：`/Users/zhengweirong/.openclaw/skills/publisher-api-skill/scripts/`
运行目录：`cd /Users/zhengweirong/code/social-auto-upload`（必须 cd 到这里再运行脚本）
...
```bash
cd /Users/zhengweirong/code/social-auto-upload && python3 \
  /Users/zhengweirong/.openclaw/skills/publisher-api-skill/scripts/ks_upload.py \
...
```bash
cd /Users/zhengweirong/code/social-auto-upload && python3 \
  /Users/zhengweirong/.openclaw/skills/publisher-api-skill/scripts/douyin_upload.py \
  --video   "~/Media/staging/{slug}/{portrait文件名}" \
  --title   "{抖音标题}" \
  --desc    "{抖音正文（不含话题）}" \
  --tags    "{话题逗号分隔，不含#，最多5个}" \
...
```bash
cd /Users/zhengweirong/code/social-auto-upload && python3 \
  /Users/zhengweirong/.openclaw/skills/publisher-api-skill/scripts/bili_stats.py \
  --bvid "{bvid}"
```
...
```bash
cd /Users/zhengweirong/code/social-auto-upload && python3 \
  /Users/zhengweirong/.openclaw/skills/publisher-api-skill/scripts/ks_stats.py \
  --title "{标题前15字}"
```
...
```bash
cd /Users/zhengweirong/code/social-auto-upload && python3 \
  /Users/zhengweirong/.openclaw/skills/publisher-api-skill/scripts/douyin_stats.py \
  --title "{标题前15字}"
```
...
```bash
cd /Users/zhengweirong/code/social-auto-upload && python3 \
  /Users/zhengweirong/.openclaw/skills/publisher-api-skill/scripts/weixin_stats.py \
  --title "{标题前15字}"
```
